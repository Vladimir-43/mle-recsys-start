...
class EventStore:
    ...
    def __init__(self, max_events_per_user=10):
        ...
        self.events = {"user1": ["itemA", "itemB", "itemC"],
    "user2": ["itemX", "itemY"],
}
    ...
    def put(self, user_id, item_id):
        """
        Сохраняет событие взаимодействия пользователя
        Добавляет новый элемент в начало списка и обрезает до max_events_per_user
        """
